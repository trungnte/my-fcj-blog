...
For our EC2 instances to be able to send session logs to the S3 bucket, we will need to up# date the IAM Role assigned to the EC2 instance by adding a policy that allows access to S3.
